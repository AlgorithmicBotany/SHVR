...
void AmbientOcclusion::generateLinearTF(int maxTexSize, std::vector<unsigned char>& out_texture1DAO) {
...
void AmbientOcclusion::importData(const Assign2::InputLight& lightSettings) {
...
void AmbientOcclusion::exportData(Assign2::InputLight& lightSettings) {
